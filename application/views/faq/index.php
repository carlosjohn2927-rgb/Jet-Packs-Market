...
<?php $this->load->view('partials/photo_writeup_hero', [
    ...
    'hero_alt'           => 'Halyk Petroleum parts specialist preparing an RFQ quotation',
    'hero_eyebrow'       => 'Parts, RFQ & certification answers',
    'hero_title_html'    => vp_inline_text('faq_hero_title', 'FAQ', 'h1', 'text-4xl lg:text-5xl font-extrabold mt-3'),
    'hero_subtitle_html' => vp_inline_text('faq_hero_subtitle', 'Answers about sourcing aircraft parts, submitting an RFQ, quotations, availability, certification, international shipping and lead times.', 'p', 'mt-3 max-w-2xl text-lg'),
]); ?>
