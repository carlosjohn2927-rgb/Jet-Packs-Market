...
$this->load->view('layouts/public', array_merge(get_defined_vars(), [
    'content' => '<section class="container mx-auto px-4 py-16 text-center">'
        . '<img src="'.IMG_URL.'system-route.jpg" alt="Aircraft system route awaiting reconnection" class="w-full max-w-2xl mx-auto aspect-[16/7] object-cover rounded-2xl shadow-sm">'
