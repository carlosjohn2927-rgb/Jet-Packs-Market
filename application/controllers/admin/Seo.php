...
/**
 * Halyk Petroleum - SEO settings (search engine optimisation).
 *
...
class Seo extends Admin_Controller
{
    ...
    private $fields = [
        ...
        'seo_google_analytics'    => ['Google Analytics 4 (GA4) Measurement ID', 'text'],
    ...
    public function index()
    {
        ...
        $values = [
            ...
            'seo_google_analytics'    => $cfg['google_analytics'],
