-- =============================================================================
-- JetPacks Market — Migration 005: marketplace part fields
-- =============================================================================
-- Adds the marketplace-specific columns to the `products` table and refreshes
-- brand settings for the JetPacks Market re-theme. Safe to re-run:
...
-- ---------------------------------------------------------------------------
-- 2. Brand / settings refresh (JetPacks Market)
-- ---------------------------------------------------------------------------
